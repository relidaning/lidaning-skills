...
- **`SESSION.md`** (project root): To describe what we have done in what time, use 1–2 sentences per session. **Update before every exit.** See [sessions.md](sessions.md) for format and rules.
